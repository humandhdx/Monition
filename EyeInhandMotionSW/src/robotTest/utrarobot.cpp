...
bool utraRobot::movetoNextPos(JointPos jPos)
{
    ...
    float acc = 3;
    int ret;
    uint8_t ubot_status = 1;
    ret = ubot->moveto_joint_p2p(joint, speed, acc, 0);
    printf("moveto_joint_p2p  : %d\n", ret);
    while (ubot_status == 1) {
       std::this_thread::sleep_for(100ms);
       ubot->get_motion_status(&ubot_status);
       std::cout << "moving to Pos... " << ubot_status
                 << std::endl;
     }
    return true;
}
...
bool utraRobot::left_arm_gravity_test()
{
 ...
 uint8_t ubot_status_left = 1;
  int ret = ubot_->moveto_joint_p2p(posjointL, speed, acc, 0);
  printf("moveto_cartesian_p2p  : %d\n", ret);
  ubot_status_left = 1;
  while (ubot_status_left == 1) {
    std::this_thread::sleep_for(1000ms);
    ubot_->get_motion_status(&ubot_status_left);
...
bool utraRobot::left_arm_accuracy_test()
{
  ...
  uint8_t ubot_status_right;
  // while (true) {

  ret = ubot_->moveto_cartesian_line(pos1, mvvelo, mvacc, 0);
  // ret = ubot->moveto_cartesian_p2p(pos1, speed, acc, 0);
  printf("moveto_cartesian_line: %d\n", ret);
  if (ret != 0) {
    uint8_t error_code[2];
    ret = ubot_->get_error_code(error_code);
  ...
  ubot_status_right = 1;
  while (ubot_status_right == 1) {
    std::this_thread::sleep_for(100ms);
    ubot_->get_motion_status(&ubot_status_right);
    // std::cout << "Moving to......" << std::endl;
  }
  ...
  ret = ubot_->moveto_cartesian_line(pos2, mvvelo, mvacc, 0);
  // ret = ubot->moveto_cartesian_p2p(pos1, speed, acc, 0);
  printf("moveto_cartesian_line: %d\n", ret);
  if (ret != 0) {
    uint8_t error_code[2];
  ...
  sleep(10);
    ...
    ret = ubot_->moveto_cartesian_line(pos3, mvvelo, mvacc, 0);
  // ret = ubot->moveto_cartesian_p2p(pos1, speed, acc, 0);
  printf("moveto_cartesian_line: %d\n", ret);
  if (ret != 0) {
    uint8_t error_code[2];
  ...
  ret = ubot_->moveto_cartesian_line(pos4, mvvelo, mvacc, 0);
  ...
  ret = ubot_->moveto_cartesian_line(pos5, mvvelo, mvacc, 0);
  // ret = ubot->moveto_cartesian_p2p(pos2, speed, acc, 0);
  printf("moveto_cartesian_line: %d\n", ret);
  if (ret != 0) {
    uint8_t error_code[2];
  ...
  sleep(10);
  ret = ubot_->moveto_cartesian_line(pos6, mvvelo, mvacc, 0);
  // ret = ubot->moveto_cartesian_p2p(pos2, speed, acc, 0);
  printf("moveto_cartesian_line: %d\n", ret);
  if (ret != 0) {
    uint8_t error_code[2];
  ...
  ret = ubot_->moveto_cartesian_line(pos7, mvvelo, mvacc, 0);
  ...
  sleep(10);
  ret = ubot_->moveto_cartesian_line(pos8, mvvelo, mvacc, 0);
  // ret = ubot->moveto_cartesian_p2p(pos3, speed, acc, 0);
  printf("moveto_cartesian_line: %d\n", ret);
  if (ret != 0) {
    uint8_t error_code[2];
 ...
 ret = ubot_->moveto_joint_p2p(posjointL, speed, acc, 0);
  printf("moveto_cartesian_p2p  : %d\n", ret);
  while (ubot_status_left == 1) {
    std::this_thread::sleep_for(1000ms);
    ubot_->get_motion_status(&ubot_status_left);
...
bool utraRobot::set_left_tcp_offset()
{
  ...
  int ret = ubot_->set_tcp_offset(configure_tcp);
...
bool utraRobot::left_arm_repeatabilitity_test()
{
 ...
 for (int i = 0; i < 5; ++i) {
  ...
  ret = ubot_->moveto_joint_p2p(posjointL2, speed, acc, 0);
  printf("moveto_cartesian_p2p  : %d\n", ret);
  while (ubot_status_left == 1) {
    std::this_thread::sleep_for(1000ms);
    ubot_->get_motion_status(&ubot_status_left);
...
bool utraRobot::right_arm_accuracy_test()
{
  ...
  uint8_t ubot_status_left = 1;
  int ret = ubot_->moveto_joint_p2p(posjointR, speed, acc, 0);
  printf("moveto_cartesian_p2p  : %d\n", ret);
  ubot_status_left = 1;
  while (ubot_status_left == 1) {
    std::this_thread::sleep_for(1000ms);
  ...
  sleep(10);
  ret = ubot_->moveto_joint_p2p(posjointR, speed, acc, 0);
  printf("moveto_joint_p2p  : %d\n", ret);
  ubot_status_right = 1;
  while (ubot_status_right == 1) {
    std::this_thread::sleep_for(100ms);
  ...
  sleep(2);
  // ret = ubot_->moveto_joint_p2p(posjointR2, speed, acc, 0);
  // printf("moveto_joint_p2p  : %d\n", ret);
  // ubot_status_right = 1;
  // while (ubot_status_right == 1) {
  //   std::this_thread::sleep_for(100ms);
